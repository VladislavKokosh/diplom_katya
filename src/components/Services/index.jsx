      ...
      <div className='services__container'>
        <div className='services__wrapper'>
          <div className='services__corn'>
            <span className='services__corn-title'>Хранение зерна</span>
            <div className='services__corn-text'>
              ОАО «Березовский комбикормовый завод» оказывает услуги по хранению
              <span className='services__corn-text-bold'> шрота соевого</span> и 
              <span className='services__corn-text-bold'> шрота подсолнечного. </span>
          ...
          <div className='services__tolling'>
            <span className='services__tolling-title'>Давальческие услуги</span>
            <div className='services__tolling-text'>
          ...
          <div className='services__sentence'>
            <span className='services__sentence-title'>ПУ «Ольшевский» предлагает:</span>
            <div className='services__sentence-text'>
            ...
            <List list={prices}/>
            <span className='services__sentence-mark'>Цены указаны в белорусских рублях.</span>
            <div className='services__sentence-phone'>
          ...
          <div className='services__manure'>
            ...
            <div className='services__manure-phone'>
